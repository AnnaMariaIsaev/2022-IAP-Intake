...
public class Intake extends SubsystemBase 
{
  ...
  private final WPI_TalonSRX intakeFlyWheelTalon;


  public Intake() 
  {
    intakeFlywheelTalon = new WPI_TalonSRX(Constants.IntakePorts.LeftFlywheelPort);
    intakeFlyWheelTalon.setInverted(true); 
...
if (RobotContainer.getJoy().getRawButton(2) && overrideTimer.get() >=  overrideTime) {
  override = !override;
  overrideTimer.reset();
  }
